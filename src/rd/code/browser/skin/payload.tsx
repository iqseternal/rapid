...
export const spacingXs = mrcvp('--rd-global-spacing-xs-unit', `calc(1 * ${spacingUnit.variable})`, '全局超小间距');  // 修复变量名和描述
export const spacingSm = mrcvp('--rd-global-spacing-sm-unit', `calc(2 * ${spacingUnit.variable})`, '全局小间距');  // 修复变量名和描述
export const spacingMd = mrcvp('--rd-global-spacing-md-unit', `calc(4 * ${spacingUnit.variable})`, '全局中等间距');  // 修复变量名和描述
export const spacingLg = mrcvp('--rd-global-spacing-lg-unit', `calc(5 * ${spacingUnit.variable})`, '全局大间距');  // 修复变量名和描述
export const spacingXl = mrcvp('--rd-global-spacing-xl-unit', `calc(6 * ${spacingUnit.variable})`, '全局超大间距');  // 修复变量名和描述

export const borderRadiusUnit = mrcvp('--rd-global-border-radius-unit', '4px', '全局圆角单位');
export const borderRadiusXs = mrcvp('--rd-global-border-radius-small-unit', `calc(0.5 * ${borderRadiusUnit.variable})`, '全局圆角单位');
export const borderRadiusSm = mrcvp('--rd-global-border-radius-small-unit', `calc(1 * ${borderRadiusUnit.variable})`, '全局圆角单位');
export const borderRadiusMd = mrcvp('--rd-global-border-radius-small-unit', `calc(2 * ${borderRadiusUnit.variable})`, '全局圆角单位');
export const borderRadiusLg = mrcvp('--rd-global-border-radius-small-unit', `calc(3 * ${borderRadiusUnit.variable})`, '全局圆角单位');
export const borderRadiusXl = mrcvp('--rd-global-border-radius-small-unit', `calc(4 * ${borderRadiusUnit.variable})`, '全局圆角单位');
...
export const colorTextPrimary = mrcvp('--rd-global-color-text-primary', colorNeutral900.variable, '全局主要文本色');  // 修改描述
export const colorTextSecondary = mrcvp('--rd-global-color-text-secondary', colorNeutral700.variable, '全局次要文本色');  // 修改描述
export const colorTextTertiary = mrcvp('--rd-global-color-text-tertiary', colorNeutral500.variable, '全局第三文本色');  // 修改描述
export const colorTextDisabled = mrcvp('--rd-global-color-text-disabled', colorNeutral400.variable, '全局禁用文本色');  // 修改描述
export const colorTextInverse = mrcvp('--rd-global-color-text-inverse', colorNeutral50.variable, '全局反色文本');  // 修改描述

export const colorTextLink = mrcvp('--rd-global-color-text-link', colorPrimary.variable, '全局链接文本色');  // 修改描述
export const colorTextSuccess = mrcvp('--rd-global-color-text-success', colorSuccess.variable, '全局成功文本色');  // 修改描述
export const colorTextWarning = mrcvp('--rd-global-color-text-warning', colorWarning.variable, '全局警告文本色');  // 修改描述
export const colorTextError = mrcvp('--rd-global-color-text-danger', colorError.variable, '全局错误文本色');  // 修改描述

export const surfacePrimary = mrcvp('--rd-global-surface-primary', colorNeutral100.variable, '全局主要表面色');  // 修改描述
export const surfaceSecondary = mrcvp('--rd-global-surface-secondary', colorNeutral50.variable, '全局次要表面色');  // 修改描述
export const surfaceTertiary = mrcvp('--rd-global-surface-tertiary', colorNeutral200.variable, '全局第三表面色');  // 修改描述

export const borderPrimary = mrcvp('--rd-global-border-primary', `1px solid ${colorNeutral300.variable}`, '全局主要边框');  // 修改描述
export const borderSecondary = mrcvp('--rd-global-border-secondary', `1px solid ${colorNeutral200.variable}`, '全局次要边框');  // 修改描述
export const borderTertiary = mrcvp('--rd-global-border-tertiary', `1px solid ${colorNeutral100.variable}`, '全局第三边框');  // 修改描述
export const borderFocus = mrcvp('--rd-global-border-focus', `1px solid ${colorPrimary.variable}`, '全局聚焦边框');  // 修改描述
export const borderError = mrcvp('--rd-global-border-error', `1px solid ${colorError.variable}`, '全局错误边框');  // 修改描述

export const interactivePrimary = mrcvp('--rd-global-interactive-primary', colorPrimary.variable, '全局主要交互色');  // 修改描述
...
export const interactivePrimaryDisabled = mrcvp('--rd-global-interactive-primary-disabled', colorNeutral300.variable, '全局主要交互禁用色');  // 修改描述

export const interactiveSecondary = mrcvp('--rd-global-interactive-secondary', colorNeutral400.variable, '全局次要交互色');  // 修改描述
export const interactiveSecondaryHover = mrcvp('--rd-global-interactive-secondary-hover', colorNeutral500.variable, '全局次要交互悬停色');  // 修改描述
export const interactiveSecondaryActive = mrcvp('--rd-global-interactive-secondary-active', colorNeutral600.variable, '全局次要交互激活色');  // 修改描述
export const interactiveSecondaryDisabled = mrcvp('--rd-global-interactive-secondary-disabled', colorNeutral200.variable, '全局次要交互禁用色');  // 修改描述
...
export const uiWidgetColorPrimary = mrcvp('--rd-ui-widget-color-primary', colorNeutral700.variable, '控件颜色');
export const uiWidgetBackgroundPrimary = mrcvp('--rd-ui-widget-background-primary', colorNeutral50.variable, '控件颜色');
export const uiWidgetHoverBackgroundPrimary = mrcvp('--rd-ui-widget-hover-background-primary', colorNeutral100.variable, '控件颜色'); // mrcvp('--rd-ui-widget-color-bg-hover-primary', colorNeutral100.variable, '控件颜色');
