...
export class ConvertService<Data extends ConvertDataType = Exclude<ConvertDataType, Blob>> {
   ...
   * @param data
   */
  public static toString<Data extends ConvertDataType>(data: Data): Data extends Blob ? Promise<string> : string;
  public static toString<Data extends ConvertDataType>(data: Data): string | Promise<string> {
  ...
  public toJson<Resp extends any>() {
   ...
   */
  public static toBuffer<Data extends ConvertDataType>(data: Data, options?: BufferEncoding): Data extends Blob ? Promise<Buffer> : Buffer;
  public static toBuffer<Data extends ConvertDataType>(data: Data, options?: BufferEncoding): Promise<Buffer> | Buffer {
    if (data instanceof Blob) {
   ...
   * @returns
   */
  public toBuffer(options?: BufferEncoding) {
   ...
   * @param data
   */
  public static toUint8Array<Data extends ConvertDataType>(data: Data): Data extends Blob ? Promise<Uint8Array> : Uint8Array;
  public static toUint8Array<Data extends ConvertDataType>(data: Data): Promise<Uint8Array> | Uint8Array {
    if (data instanceof Blob) {
   ...
   * @param data
   */
  public static toBlob<Data extends ConvertDataType>(data: Data): Data extends Blob ? Promise<Blob> : Blob;
  public static toBlob<Data extends ConvertDataType>(data: Data): Promise<Blob> | Blob {
    if (data instanceof Blob) {
