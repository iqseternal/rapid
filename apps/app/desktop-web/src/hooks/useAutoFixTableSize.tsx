...
export function useAutoFixTableSize<RecordType extends Record<string, unknown>>(tableRef: RefObject<HTMLDivElement>, autoFixTableProps: AutoFixTableSizeOptions<RecordType>) {
  ...
  useEffect(() => {
    ...
    const autoGetParentScrollContainer = useDebounceHook(getParentScrollContainer, 20);
    ...
    const autoCalcMoreHAndAdjust = useThrottleHook(calcMoreHAndAdjust, 4);
    ...
    const autoGetMoreElement = useDebounceHook(getMoreElement, 20);
