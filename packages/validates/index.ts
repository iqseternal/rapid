 ...
 * @returns
 */
export const validateIsSpaceStr = (str: string) => typeof str === 'string' && str.trim() === '';
 ...
 * @returns
 */
export const validateValidStr = (str: string) => typeof str === 'string' && !validateIsSpaceStr(str);
 ...
 * @returns
 */
export const validateRealName = (str: string) => typeof str === 'string' && /^[\u4E00-\u9FA5]{2,10}(·[\u4E00-\u9FA5]{2,10}){0,2}$/.test(str);
