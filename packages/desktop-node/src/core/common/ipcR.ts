...
import { type MainEventHandlers, IPC_MAIN_WINDOW, RendererEventHandlers } from '@rapid/config/constants';
/**
 ...
 * @returns
 */
export const ipcR = <T extends any = any>(callback: (ok: IpcPromiseCall<T>, fail: IpcPromiseCall<T>) => ReturnType<IpcPromiseCall<T>>): Promise<IpcResponse<T>> => {
