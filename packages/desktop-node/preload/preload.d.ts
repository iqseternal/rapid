...
import type { IpcDevToolHandler, IpcStoreHandler, IpcWindowHandler } from '../src/setupHandles';
...
export type Handlers = NamedHandler<IpcDevToolHandler> & NamedHandler<IpcStoreHandler> & NamedHandler<IpcWindowHandler>;
