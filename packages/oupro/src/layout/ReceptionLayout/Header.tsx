...
import { AppAdapter, FlexRowBetween, FlexRowStart, FullSizeWidth, MaxScreenHeight, combinationStyled } from '@/styled';
...
import { MaxScreenWidth } from '@/styled';
...
const NavContainer = combinationStyled('nav', FullSizeWidth, AppAdapter);
